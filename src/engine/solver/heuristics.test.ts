...
describe('Solver Heuristics', () => {
  describe('MRV (Minimum Remaining Values)', () => {
    const shift1: Shift = { id: 's1', dayOfWeek: 1, start: '09:00', end: '17:00', role: 'RN', durationHours: 8, isAssigned: false }
    const shift2: Shift = { id: 's2', dayOfWeek: 2, start: '09:00', end: '17:00', role: 'RN', durationHours: 8, isAssigned: false }
    const shift3: Shift = { id: 's3', dayOfWeek: 3, start: '09:00', end: '17:00', role: 'RN', durationHours: 8, isAssigned: false }
  ...
  describe('Fairness Scoring (LCV)', () => {
    const emp1: Employee = { id: 'e1', name: 'A', role: 'RN', maxHours: 40, minHours: 0, targetHours: 36, isFullTime: true, availability: [], createdAt: 0, updatedAt: 0 }
    const emp2: Employee = { id: 'e2', name: 'B', role: 'RN', maxHours: 40, minHours: 0, targetHours: 36, isFullTime: true, availability: [], createdAt: 0, updatedAt: 0 }
    const emp3: Employee = { id: 'e3', name: 'C', role: 'RN', maxHours: 40, minHours: 0, targetHours: 36, isFullTime: true, availability: [], createdAt: 0, updatedAt: 0 }
